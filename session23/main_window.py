...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QRect(0, 0, 521, 561))
        ...
        self.menuNew.addAction(self.menu_new)
        self.menuNew.addAction(self.menu_open_file)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuNew.setTitle(QCoreApplication.translate("MainWindow", u"Game", None))
    # retranslateUi
